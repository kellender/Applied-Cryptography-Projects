...
\fancyhead[L]{Ajay Shenoy, George Lin, Shearyar Shamim Khan}
\fancyhead[R]{Cryptanalysis of Permutation Ciphers}
...
\title{  
		\HRule{0.5pt} \\
		\LARGE \textbf{Cryptanalysis of Permutation Ciphers}
		\HRule{2pt} \\ [0.5cm]
